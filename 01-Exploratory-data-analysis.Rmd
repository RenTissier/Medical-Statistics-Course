...
```{r fig.height=5, fig.width=5, fig.show="hold", out.width="50%"}
curve(dnorm(x, mean=0, sd=1), col="blue", from=-5, to=5,
      ylab="Probability density", main="dnorm(1.0) = 0.24")
...
```{r fig.height=5, fig.width=5, fig.show="hold", out.width="50%"}
curve(dnorm(x, mean=0, sd=1), col="blue", from=-5, to=5,
      ylab="Probability density", main="pnorm(1.0) = 0.84")
ax <- seq(-5, 1, 0.01)
...
```{r fig.height=5, fig.width=5, fig.show="hold", out.width="50%"}
curve(dnorm(x, mean=0, sd=1), col="blue", from=-5, to=5,
      ylab="Probability density", main="qnorm(0.84) = 1.0")
ax <- seq(-5, 1, 0.01)
polygon(c(-5, ax, 1), c(0, dnorm(ax), 0), col="lightblue", lty=2)
...
$\sigma_{pooled} = \sqrt(\frac{(n1-1)*s1^{2}+ (n2-1)*s2^{2}}{n1+n2-2})$
