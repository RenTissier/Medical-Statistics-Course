...
We can see that we would need `r ceiling(test.80.percent$n, 0)` samples in each group for a power of 80% and `r ceiling(test.90.percent$n, 0)` for a power of 90%. 
